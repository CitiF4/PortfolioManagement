...
public class Position {
    ...
    public Position(String symbol,String type){
        this.symbol = symbol;
        this.type = type;
    }

    public Position(Integer id, Integer qty, String symbol, Double price, String ccy, String type, Integer portfolioid, java.sql.Date date,Double value,Double profit) {
        this.id = id;
        this.qty = qty;
        this.symbol = symbol;
        this.price = price;
